...
export default function CareerCurrentBadge({label}: CareerCurrentBadgeProps) {
    return (
        <span className="inline-flex items-center rounded-full border border-(--color-teal) bg-[rgba(20,184,166,0.15)] px-2 py-0.5 text-xs font-medium text-(--color-accent)">
