    ...
    return (
        <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center gap-3">
                <h3 className="px-1 text-xs font-bold uppercase tracking-[0.2em] text-(--color-accent)">
                    {section.title}
                </h3>
                <div className="h-px flex-1 bg-(--color-accent) opacity-10" />
            </div>
            ...
            <div className="marquee-track relative overflow-hidden">
                ...
                <div
                    className={`marquee-inner flex w-max gap-3 py-3 ${reverse ? "marquee-reverse" : "marquee"}`}
                >
                    {repeated.map((item, i) => (
