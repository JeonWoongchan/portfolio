...
export const CAREER_DATA = [
    {
        ...
        projects: [
            {
                title: '머신러닝 기반 교통 신호 최적화 모니터링 시스템',
                periodStart: '2025.10',
                periodEnd: '2025.12',
                roles: ['Frontend 개발'],
                description:
    ...
    },
    {
        ...
        projects: [
            ...
            },
            {
                ...
                highlights: [
                    'Cesium.js 기반 3D 모델 렌더링 구조를 개선하여 초기 로딩 시간을 약 30초에서 5초 미만으로 단축',
                    '3D 객체 누적에 따른 메모리 누수 구간을 개선하여 장시간 구동 시 메모리 사용량을 최대 1.5GB에서 500MB 미만으로 절감',
            ...
            },
            {
                ...
                periodStart: '2024.05',
                periodEnd: '2024.07',
                roles: ['기획', 'Frontend 개발', 'Backend 개발'],
                description:
